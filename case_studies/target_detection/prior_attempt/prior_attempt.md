...
![prior attempt](./media/target-selection-prior-attempt-explain.png)

### Video Demonstration.

Left Right Swing pass.

![prior attempt sample 1](./media/prior_attempt_sample_1.gif)

Precision targeting.

![prior attempt sample 2](./media/prior_attempt_sample_2.gif)
...
![bad example](./media/bad_example.jpg)
...
![tracy stress test](./media/tracy_stressed.png)